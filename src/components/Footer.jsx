...
//   return (
//     <footer className="bg-gray-800 text-white py-14 px-20 w-full mt-16">
    ...
    <footer className="bg-gray-800 text-white py-14 px-20 w-full mt-16 mb-0">
      <div className="container mx-auto flex justify-between items-center">
        <div>
          <p className="text-lg">
            {t('contactusviaemail')}: 
            <a href="mailto:dvadigitalkirkos@gmail.com" className="text-blue-400 hover:text-blue-600 ml-1">
              dvadigitalkirkos@gmail.com
            </a>
          </p>
        </div>
